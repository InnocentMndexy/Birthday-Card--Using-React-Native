    ...
    <View style={{
      ...
      <View style={{alignContent:'center',margin:'auto',marginLeft:'45%'}}>
        <View style={{color:'gold',marginTop:'30%',fontSize:20,marginLeft:'-40%'}} >
          ...
          <Text style={{color:'rgb(206, 188, 84)',fontSize:16,}}>You are a wonderful person </Text>
          <Text style={{color:'rgb(206, 188, 84)',fontSize:16,}}>I hope your special day is the</Text>
          <Text style={{color:'rgb(206, 188, 84)',fontSize:16,}}>beginning of another amazing year</Text>
          <Text style={{color:'rgb(206, 188, 84)',fontSize:16,marginLeft:'20%'}}>Have a blissful day </Text>
        </View>

        <marquee style={{color:'rgb(252, 189, 30)',fontSize:32,marginLeft:'-30%'}} behavior="slide" direction="left">Happy Birthday...</marquee>
